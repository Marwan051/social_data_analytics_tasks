...
def run_ml_pipeline():
    ...
    for scheme in schemes:
        ...
        labels_path = f"../../data/scored_data/cleaned_reviews_{scheme}_scored.csv"
        ...
        try:
            ...
            # 3. GloVe Evaluation
            print("\n--- Text Rep: GloVe ---")
            X_train_g, X_test_g, y_train_g, y_test_g = train_test_split(X_glove, y, test_size=0.2, random_state=42)
            ...
            print(f"Please check the exact column name in '{labels_path}' and update TARGET_COLUMN at the top of the script.\n")
